...
public class PianoPages : IPages
{
	...
	public void CreatePages()
	{
		...
		pages.Add("The keys are attached to hammers, which hit bundles of string. The strings make beautiful sound. You can make the sounds longer by pressing a pedal with your foot.");
		...
		pages.Add("More Info about Pianos");
	}
