...
public class PercussionPages : IPages
{
	...
	public void CreatePages()
	{
		...
		pages.Add("The percussion family is HUGE! There are lots of different instruments in it. Anything you can hit becomes a percussion instrument. Examples of percussion instruments in the orchestra are the snare drum, the bass drum, and the timpani.");
